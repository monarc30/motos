-- =============================================================================
-- Criação das tabelas no banco segencom_motos (produção)
-- Banco já deve existir. Rodar: mysql -u segencom_motos -p segencom_motos < database/schema_segencom_motos.sql
-- =============================================================================
